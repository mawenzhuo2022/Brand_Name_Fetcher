# -*- coding: utf-8 -*-
# @Author  : Wenzhuo Ma
# @Time    : 2024/5/27 11:12
# @Function:
import unittest
import requests_mock
from src.website_fetcher import get_brand_names_from_wikipedia  # Make sure to adjust the import path according to your project structure.

class TestWebsiteFetcher(unittest.TestCase):
    @requests_mock.Mocker()
    def test_get_brand_names_from_existing_page(self, m):
    ...
    @requests_mock.Mocker()
    def test_get_brand_names_from_non_existing_page(self, m):
    ...
    @requests_mock.Mocker()
    def test_get_brand_names_from_page_without_interlanguage_links(self, m):
